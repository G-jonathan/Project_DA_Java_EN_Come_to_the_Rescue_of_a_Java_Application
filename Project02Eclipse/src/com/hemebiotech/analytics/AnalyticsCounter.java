...
public class AnalyticsCounter {
	...
	public static void main(String args[]) throws Exception {
		...
		deduplication.add("Prout"); //TO DO delete
		System.out.println(deduplication); //TO DO delete
		System.out.println(result); //TO DO delete
		
		
		for (int i =0; i< result.size(); i++) { // browse all the table
			
			boolean exist = false;
			int nombre =0;
			String symptomReading = result.get(i);
